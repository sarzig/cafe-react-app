                            ...
                            <div className="col-md-8">
                                <div className="row">
                                    <div className="col-md-10">
                                        ...
                                        <br />
                                        <h6 className="mt-3 bold">Add user data:</h6>
                                        ...
                                        <br />
                                        <h6 className="mt-2 bold">Favorite drinks:</h6>
                                        ...
                                        <br />
                                        <h6 className="mt-2 bold">Favorite recipes:</h6>
